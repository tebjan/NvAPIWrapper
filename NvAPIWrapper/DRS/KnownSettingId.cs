...
#pragma warning disable 1591
    public enum KnownSettingId : UInt32
    {
        ...
        /// </summary>
        [Description("OpenGL GDI compatibility")]
        OpenGLControlPanelGdiCompatibility = 0x2072C5A3,

        /// <summary>
        ///      Vulkan/OpenGL present method
        /// </summary>
        [Description("Vulkan/OpenGL present method")]
        OpenGLControlPanelPreferDxpresent = 0x20D690F8,
        ...
        /// <summary>
        ///      Idle Application Max FPS Limit
        /// </summary>
        [Description("Idle Application Max FPS Limit")]
        AppidleDynamicFrlFPS = 0x10835016,

        /// <summary>
        ///      Idle Application Threshold Time out in seconds
        /// </summary>
        [Description("Idle Application Threshold Time out in seconds")]
        AppidleDynamicFrlThresholdTime = 0x10835017,
        ...
        /// </summary>
        [Description("Battery Boost Application FPS")]
        BatteryBoostApplicationFPS = 0x10115C8C,
        ...
        /// <summary>
        ///      External Quiet Mode (XQM)
        /// </summary>
        [Description("External Quiet Mode (XQM)")]
        ExternalQuietMode = 0x10115C8D,
        ...
        /// <summary>
        ///      Autoalign flash indicator
        /// </summary>
        [Description("Autoalign flash indicator")]
        LatencyIndicatorAutoalign = 0x1095F170,
        ...
        /// <summary>
        ///      shader cache path to dll
        /// </summary>
        [Description("shader cache path to dll")]
        PerformanceStateShaderDiskCacheDllPathWchar = 0x19A002,

        /// <summary>
        ///      Shader disk cache maximum size
        /// </summary>
        [Description("Shader disk cache maximum size")]
        PerformanceStateShaderDiskCacheMaximumSize = 0xAC8497,
        ...
        /// </summary>
        [Description("Texture filtering - Quality Substitution")]
        QualityEnhancementSubstitution = 0xCE2692,
